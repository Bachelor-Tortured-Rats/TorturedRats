...
python3 /zhome/a2/4/155672/Desktop/Bachelor/TorturedRats/src/pipelines/finetune_wrt_labelsproportion.py —-id $LSB_JOBID -d hepatic -s "3drpl" -l "online" --model_load_path "models/selfsupervised_pretask_models/hepatic/3drpl/3drpl_hepatic__e500_k3_d0_lr1E-04_a_bmm.pth" -lp '[.01,0.03,0.06,0.10,1.00]' --terminate_at_step_count "24000"
