...
python3 /zhome/a2/4/155672/Desktop/Bachelor/TorturedRats/src/pipelines/finetune_wrt_labelsproportion.py -d hepatic --model_load_path "models/IRCAD__e300_k3_d0.1_lr1E-03_aTrue_bmm.pth" --model_save_path "models/finetune/hepatic/transfer" -lr "1e-4"  -l "online" -lp '[.1,.25,.5,.75,1]' -e "999999" --terminate_at_step_count "15000" -s "transfer"
